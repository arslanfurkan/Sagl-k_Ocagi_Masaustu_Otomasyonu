...
namespace Sağlık_Ocağı_Hasta_Takip_Sistemi_163301012.Views
{
    public partial class HastaIslemleriForm : Form
    {
        ...
        public DosyaBulForm _dosyaBul = null;
        ...
        protected HastaIslemleriForm(AnaForm anaForm)
        {
            InitializeComponent();
            _anaForm = anaForm;
        }
        public static HastaIslemleriForm HastaIslemleriFormuOlustur(AnaForm anaForm)
        {
        ...
        public static void HastaIslemleriFormuKapat()
        {
            if (hastaIslemleri != null)
            {
                ...
                {
                    DosyaBulForm.DosyaBulFormuKapat();
                }
        ...
        {
            _dosyaBul = DosyaBulForm.DosyaBulFormOlustur(_anaForm);
